...
from app.models import Genre  # Adjust import based on your actual project structure
...
def generate_genre_seed_data(data_file=None):
    ...
    """
    # Start with common genres
    all_genres = create_common_genres()
    
    # Add genres from data file if provided
    if data_file:
        data_genres = collect_genres_from_data(data_file)
        # Add any genres from the data that aren't in our common list
...
def create_seed_sql(seed_data, output_file="genre_seed.sql"):
    """Create SQL insert statements for the seed data"""
    sql_statements = []
...
if __name__ == "__main__":
    # Generate seed data
    data_file = "processed/processed_data"  # Use your data file
